...
import { View, Text, TextInput, Button, Alert, StyleSheet, TouchableOpacity, ActivityIndicator, Platform } from 'react-native';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                >
                    ...
                    <RNPicker.Item label="Father" value="father" />
                    <RNPicker.Item label="Mother" value="mother" />
                    <RNPicker.Item label="Sibling" value="sibling" />
                    <RNPicker.Item label="Grandparent" value="grandparent" />
                </RNPicker>
                    )} */}
                    <RNPickerSelect
                        ...
                        placeholder={{ label: 'Select a family relation: *', value: '' }}
