...
const vitalsData = [
    { id: '1', title: 'Blood Pressure', icon: require('../assets/pressure.png'), screen: 'pressure' },
    { id: '2', title: 'BMI', icon: require('../assets/bmi.png'), screen: 'bmi' },
    { id: '3', title: 'Blood Sugar', icon: require('../assets/sugar.png'), screen: 'sugar' },
    { id: '4', title: 'Oxygen Level (SpO2)', icon: require('../assets/oxygen.png'), screen: 'oxygen' },
    { id: '5', title: 'Pulse', icon: require('../assets/pulse.png'), screen: 'pulse' },
];
