  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Ionicons name="add-circle-outline" size={30} color="#6b1f58" onPress={() => navigation.navigate('addpulse')}/>
      </View>
      ...
      <View style={styles.chartContainer}>
        <LineChart
          data={{
            labels: pulseData.map(item => item.date),
            datasets: [
              {
                data: pulseData.map(item => item.value),
                color: () => '#3b82f6', 
              },
            ],
            legend: ['Pulse'],
      ...
      <View style={styles.tableContainer}>
        <View style={styles.tableHeader}>
          ...
          <Text style={styles.tableHeaderText}>Pulse</Text>
        </View>
